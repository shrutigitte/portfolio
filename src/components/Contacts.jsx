  ...
  return (
    <div className="pb-20">
      ...
      className="tracking-tighter text-center">
        ...
        <a href="#" className="text-fuchsia-600 font-medium border-b border-fuchsia-600"> <span className="font-normal text-blue-500 border-none" >email:-</span> {CONTACT.email}</a>
      </div>
    </div>
  );
};
